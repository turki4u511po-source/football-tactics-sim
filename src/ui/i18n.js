...
export const DICT = {
  ...
  preMatchTitle: { ar: 'التخطيط قبل المباراة', en: 'Pre-match planning' },
  teamsTitle: { ar: 'الفِرق', en: 'Teams' },
  yourTactics: { ar: 'تكتيكك', en: 'Your tactics' },
  kickOff: { ar: 'ابدأ المباراة', en: 'Kick off' },
  back: { ar: 'رجوع', en: 'Back' },
  invFB: { ar: 'ظهير مقلوب', en: 'Inverted FB' },
  rematch: { ar: 'إعادة المباراة', en: 'Rematch' },
